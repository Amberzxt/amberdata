function main()
{
    ...
    var id=faces[0];
    var f0=new THREE.Face3(id[0],id[2],id[1]);
    var f1=new THREE.Face3(id[2],id[0],id[3]);
    var f2=new THREE.Face3(id[7],id[5],id[6]);
    var f3=new THREE.Face3(id[5],id[7],id[4]);
    var f4=new THREE.Face3(id[4],id[1],id[5]);
    var f5=new THREE.Face3(id[1],id[4],id[0]);
    var f6=new THREE.Face3(id[3],id[6],id[2]);
    var f7=new THREE.Face3(id[6],id[3],id[7]);
    var f8=new THREE.Face3(id[4],id[3],id[0]);//y
    var f9=new THREE.Face3(id[3],id[4],id[7]);
    var f10=new THREE.Face3(id[1],id[6],id[5]);
    var f11=new THREE.Face3(id[6],id[1],id[2]);
    ...
    geometry.faces[3].color = new THREE.Color(1,0,1);
